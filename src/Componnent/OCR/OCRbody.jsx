            ...
            for (let itemIndex = 0; itemIndex < saveItems[index].length; itemIndex++) {
                ...
                while (isProcessing) {
                    const response = await axios.post(
                        'https://195.191.45.56:17017/download_excel',
    ...
    const handelDownloadPdf = async (index) => {
        try {
            ...
            for (let itemIndex = 0; itemIndex < saveItems[index].length; itemIndex++) {
                ...
                while (isProcessing) {
                    const response = await axios.post(
                        'https://195.191.45.56:17017/download_pdf',
                        { document_url: url_document }
                    );
    ...
    const handelDownloadWord = async (index) => {
        try {
            ...
            for (let itemIndex = 0; itemIndex < saveItems[index].length; itemIndex++) {
                ...
                while (isProcessing) {
                    const response = await axios.post(
                        'https://195.191.45.56:17017/download_word',
                        { document_url: url_document }
                    );
                                    ...
                                    <div className='sm:mx-6 mx-0 mt-1'>
                                        ...
                                        <div className='flex'>
                                            <div className='flex justify-between w-full'>
                                                ...
                                                <button
                                                    className='border-dotted bg-gray-300 border-black rounded-md border-2 md:px-4 px-2 pt-1 pb-2 mx-2 sm:text-xl text-xs font-semibold text-center flex items-center hover:scale-105 duration-200'
