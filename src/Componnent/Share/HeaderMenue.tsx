        ...
        <div className="w-full sticky flex lg:px-14 px-5 py-2 mx-auto justify-between items-center border-b-2">
            ...
            <div className="flex items-center text-blue-800">
                ...
                >
                    ...
                    <option className="font-extrabold cursor-pointer" value="/SpeechEnhancement">
                        بهبود کیفیت صدا
                    </option>
                    ...
                    <option className="font-extrabold cursor-pointer" value="/SuperResolution">
                      بهبود کیفیت عکس
                    </option>
                </select>
                <span onClick={()=>navigate('/')} className="mx-2 text-4xl cursor-pointer">
                    <MdHome />
                </span>
            </div>
        </div>
